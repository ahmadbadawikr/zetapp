    ...
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        <p className='mt-5 max-w-prose text-slate-700 sm:text-lg'>
          Zetapp allows you to have conversations with any PDF document. Just upload your file and start asking questions right away.
        </p>
        <Link 
          href={'/dashboard'} 
          target='_blank' 
        ...
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
            ...
            <p className='mt-4 text-lg text-gray-600'>
              Getting summaries of your PDF files has never been easier with Zetapp
            </p>
          </div>
        </div>
